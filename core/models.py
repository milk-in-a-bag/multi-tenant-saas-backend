...
class AuditLog(TenantIsolatedModel):
    ...
    tenant = models.ForeignKey(
        "tenants.Tenant", on_delete=models.CASCADE, related_name="audit_logs", db_column="tenant_id"
    )
...
class RateLimit(models.Model):
    ...
    tenant = models.OneToOneField(
        "tenants.Tenant", on_delete=models.CASCADE, primary_key=True, related_name="rate_limit", db_column="tenant_id"
    )
